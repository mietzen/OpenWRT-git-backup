...
echo ""
echo "Next steps:"
echo "  1. Install dependencies (lua, git, wget)"
echo "     - CRITICAL: opkg update && opkg install lua"
echo "     - Then install git/wget via UI or: opkg install git wget"
...
echo ""
echo "Note: When installed via opkg package, ALL dependencies"
echo "      (including lua) are automatically installed."
echo "      Manual installation requires manual dependency installation."
echo ""
