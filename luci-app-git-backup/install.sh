...
echo "     - Use the 'Install Dependencies' button in the web UI"
echo "     - Or run: opkg update && opkg install git wget"
echo "  2. Configure your repository"
echo "  3. Generate SSH key or configure HTTPS auth"
echo "  4. Enable automatic backups"
echo ""
echo "Note: When installed via opkg package, dependencies are"
